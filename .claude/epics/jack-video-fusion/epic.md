...
## Tasks Created
- [ ] 001.md - 项目骨架与全局布局(并行: true)
- [ ] 002.md - 持久化与配置服务(SQLite + JSON 配置)(并行: true,依赖 001)
- [ ] 003.md - FFmpeg IPC 服务封装(并行: true,依赖 001)
- [ ] 004.md - 素材仓库与文件夹隔离机制(并行: true,依赖 002)
- [ ] 005.md - 任务队列(排队/暂停/终止/断点续)(并行: true,依赖 002)
- [ ] 006.md - 微软 Edge-TTS 服务与 SRT 生成(并行: true,依赖 003)
- [ ] 007.md - 素材处理模块 UI + 服务(分割/文本分割/字幕提取)(并行: true,依赖 003,004)
- [ ] 008.md - 视频混剪双模式(随机混剪 + 文件夹音频匹配)(并行: false,依赖 003,004,005,007)
- [ ] 009.md - 通用能力(水印/字幕/分辨率/日志面板)(并行: true,依赖 001,003)

Total tasks: 9
Parallel tasks: 8
Sequential tasks: 1
Estimated total effort: 约 90-130 人时(V1.0)

> V1.1 / V1.2 任务将在 V1.0 完成后追加到独立 epic 或本 epic 的增量批次。
